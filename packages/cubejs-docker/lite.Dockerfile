...
COPY packages/cubejs-themis-driver/package.json packages/cubejs-themis-driver/package.json
...
COPY packages/cubejs-themis-driver/ packages/cubejs-themis-driver/
